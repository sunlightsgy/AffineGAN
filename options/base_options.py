...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='affineGAN',
                            help='chooses how datasets are loaded')
        parser.add_argument('--model', type=str, default='affineGAN',
                            help='chooses which model to use')
        parser.add_argument('--epoch', type=str, default='latest', help='which epoch to load? set to latest to use '
                                                                        'latest cached model')
